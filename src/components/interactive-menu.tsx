...
import supBacon from "@/assets/sup-bacon.jpg";
import supFries from "@/assets/sup-fries.jpg";
import supGratin from "@/assets/sup-gratin.jpg";
import supSauce from "@/assets/sup-sauce.jpg";
import supEgg from "@/assets/sup-egg.jpg";
...
const categories: Category[] = [
  {
    ...
    icon: "🍔",
    items: [
      { name: "Cheeseburger", img: burgerImg, prices: [{ label: "S", price: 37 }, { label: "M", price: 47 }] },
      { name: "Double Cheeseburger", img: burgerImg, prices: [{ label: "S", price: 47 }, { label: "M", price: 67 }] },
      {
        name: "Pepper Burger",
        desc: "Viande hachée, sauce poivre, cheddar, oignon cuit",
        img: burgerImg,
        prices: [{ label: "S", price: 47 }, { label: "M", price: 67 }],
      },
      {
        name: "Chicken Burger",
        desc: "Poulet frit, cheddar, sauce Biggy",
        img: burgerImg,
        prices: [{ label: "S", price: 37 }, { label: "M", price: 47 }],
      },
      {
        name: "Bacon Burger",
        desc: "Viande hachée, jambon fumé, oignon caramélisé, barbecue, cheddar",
        img: burgerImg,
        prices: [{ label: "S", price: 45 }, { label: "M", price: 67 }],
      },
      {
        name: "Burger Presto",
        desc: "Steak kefta, œuf, kefta, mozzarella, poivron, oignon caramélisé, barbecue, cheddar",
        img: burgerImg,
        prices: [{ label: "S", price: 50 }, { label: "M", price: 67 }],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    icon: "➕",
    items: [
      { name: "Fromage extra fondant", img: supCheese, prices: [{ label: "Extra", price: 5 }] },
      { name: "Viande ou poulet", img: supMeat, prices: [{ label: "Extra", price: 10 }] },
      { name: "Bacon grillé", img: supBacon, prices: [{ label: "Extra", price: 9 }] },
      { name: "Double portion frites", img: supFries, prices: [{ label: "Extra", price: 10 }] },
      { name: "Gratiné fromage", img: supGratin, prices: [{ label: "Extra", price: 10 }] },
      { name: "Sauce", img: supSauce, prices: [{ label: "Extra", price: 3 }] },
      { name: "Œuf", img: supEgg, prices: [{ label: "Extra", price: 5 }] },
      {
        name: "Tacos Gratiné",
    ...
    <article className="w-[80vw] max-w-[320px] shrink-0 snap-center overflow-hidden rounded-3xl bg-surface p-5 transition-transform duration-300 hover:-translate-y-1 sm:w-full sm:max-w-none">
      <div className="flex items-start gap-4">
        <img
          ...
          width={512}
          height={512}
          className="h-20 w-20 p-1 shrink-0 rounded-full object-cover ring-2 ring-gold/30"
        />
